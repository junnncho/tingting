...
export const surveyStatuses = ["applied", "surveying", "closed", "inactive"] as const;
...
export const defaultVideoStat = {
  viewNum: 0,
  clickNum: 0,
  payNum: 0,
  commentNum: 0,
} as const;
export const defaultAccessStat = {
  request: 0,
  device: 0,
  ip: 0,
  country: 0,
...
export const holdemPlaceTypes = ["daily", "jobnament"] as const;
...
export const courseStatuses = ["active", "published", "inactive"] as const;
...
export const groupStatuses = ["active", "restricted", "inactive"] as const;
export type GroupStatus = (typeof groupStatuses)[number];

export const contestMedals = ["gold", "silver", "bronze"] as const;
export type ContestMedal = (typeof contestMedals)[number];

export const submissionStatuses = ["active", "evaluated", "ranked", "failed", "inactive"] as const;
export type SubmissionStatus = (typeof submissionStatuses)[number];

export const contestTypes = ["inhouse", "outdoor"] as const;
export type ContestType = (typeof contestTypes)[number];

export const contestStatuses = ["active", "closed", "inactive"] as const;
export type ContestStatus = (typeof contestStatuses)[number];

export const contestFileTypes = ["json", "csv"] as const;
export type ContestFileType = (typeof contestFileTypes)[number];
...
export const defaultContestStat = {
  view: 0,
  like: 0,
  unlike: 0,
  group: 0,
...
export const interests = ["math", "science", "english", "korean", "social", "art", "music", "sports"] as const;
...
export const chatBoardStatuses = ["active", "inactive"] as const;
export type ChatBoardStatus = (typeof chatBoardStatuses)[number];

export const epochxyUserTiers = [0, 1, 2, 3, 4]; // 초심자, 중수, 고수, 마스터, 그랜드마스터
export type EpochxyUserTier = (typeof epochxyUserTiers)[number];

export const jobStatuses = ["active", "inactive", "recruiting", "closed"] as const;
export type JobStatus = (typeof jobStatuses)[number];

export const questStatuses = ["active", "inactive"] as const;
export type QuestStatus = (typeof questStatuses)[number];

export const questVerifyStatuses = ["pending", "completed", "rejected"] as const;
export type QuestVerifyStatus = (typeof questVerifyStatuses)[number];

export const managerSummaryStatuses = ["active", "inactive"] as const;
export type ManagerSummaryStatus = (typeof managerSummaryStatuses)[number];

export const gameStatuses = ["ing", "end", "complete"] as const;
export type GameStatus = (typeof gameStatuses)[number];

export const accountStatuses = ["active", "inactive"] as const;
export type AccountStatus = (typeof accountStatuses)[number];

export const ticketStatuses = ["ing", "end"] as const;
export type TicketStatus = (typeof ticketStatuses)[number];

export type Choice = [number, number, number, number, number];
...
export const tourStatuses = ["ing", "end"] as const;
