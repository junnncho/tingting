...
const state = (setget, suffix: string) => ({
  ...createState(gql.keyringGraphQL),
  ...createActions(gql.keyringGraphQL, setget, suffix),
});
...
export type KeyringSliceState = Get<typeof state, typeof actions>;
export type KeyringSlice = Slice<"keyring", KeyringSliceState>;
