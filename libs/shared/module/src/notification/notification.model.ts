...
import { NotificationInput, NotificationSchema } from "./notification.gql";
import { Schema, SchemaFactory } from "@nestjs/mongoose";
import { dbConfig } from "@shared/util-server";
@Schema(dbConfig.defaultSchemaOptions)
class Notification extends NotificationSchema {}
export const name = Notification.name;
export type Input = NotificationInput;
export type Raw = Notification;
