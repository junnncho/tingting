...
import { ThingInput, ThingSchema } from "./thing.gql";
import { dbConfig } from "@shared/util-server";
@Schema(dbConfig.defaultSchemaOptions)
class Thing extends ThingSchema {}
export const name = Thing.name;
export type Input = ThingInput;
export type Raw = Thing;
...
schema.index({ name: "text", description: "text", purpose: "text" });
