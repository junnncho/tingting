...
import { EmojiInput, EmojiSchema } from "./emoji.gql";
import { Schema, SchemaFactory } from "@nestjs/mongoose";
import { dbConfig } from "@shared/util-server";
@Schema(dbConfig.defaultSchemaOptions)
class Emoji extends EmojiSchema {}
export const name = Emoji.name;
export type Input = EmojiInput;
export type Raw = Emoji;
