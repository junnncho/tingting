import { ChatBoardInput, ChatBoardSchema } from "./chatBoard.gql";
...
class ChatBoard extends ChatBoardSchema {}
export const name = ChatBoard.name;
export type Input = ChatBoardInput;
export type Raw = ChatBoard;
...
export type ChatBoardResolve = Overwrite<Doc, { rootRoom: ChatRoomResolve; recentRoom: ChatRoomResolve }>;
