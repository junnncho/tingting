...
import { ServiceDeskInput, ServiceDeskSchema } from "./serviceDesk.gql";
import { dbConfig } from "@shared/util-server";
@Schema(dbConfig.defaultSchemaOptions)
class ServiceDesk extends ServiceDeskSchema {}
export const name = ServiceDesk.name;
export type Input = ServiceDeskInput;
export type Raw = ServiceDesk;
