...
import { Awaitable, ClientEvents, WebhookClient } from "discord.js";
import { DiscordBot, DiscordToken, LogService, makeDiscordBot } from "@shared/util-server";
import { Inject, Injectable } from "@nestjs/common";
@Injectable()
export class DiscordService extends LogService {
  constructor(
    @Inject("DISCORD_BOTS") private bots: Map<string, DiscordBot>,
    @Inject("DISCORD_WEBHOOK") private webhook: WebhookClient
  ) {
