import { EmployerOutlined } from "@localjobs/frontend/components";
      ...
      <div className=" w-full flex justify-around my-10 ">
        <div className=" w-1/3 px-2">
          <button
            ...
            onClick={() => router.push("/employer/job/new")}
          >
            <EmployerOutlined className="w-full h-max mt-auto max-h-40" />
