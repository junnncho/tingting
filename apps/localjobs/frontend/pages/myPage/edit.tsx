  ...
  return (
    <div className="pb-20 pt-4">
      <div className="text-center mb-5">
        ...
        {/* <Image
          src={self.image?.url ?? "/localjobs_logo.png"}
          width={190}
          height={190}
      ...
      <div className="w-full flex flex-row border-y border-secondary py-4 font-semibold text-xl">
        <span className="ml-5 text-base font-bold">닉네임 변경</span>
      ...
      <div className="flex flex-row justify-center mt-5">
        <button
          className="btn mx-2 px-2 w-24 text-white rounded-xl text-sm font-extralight"
          onClick={() => {
