...
import { locationMap } from "@shared/util";
    ...
    <div className="flex flex-col w-full min-h-screen">
      ...
      <div className="flex items-center justify-center mx-10 align-middle">
        <div className="">
          ...
          <div className="flex my-6">
            <div className="w-28 items-center align-middle flex justify-center">닉네임</div>
            <Input
              className=""
          ...
          <div className="flex my-6">
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                console.log(userForm.dateOfBirth.format("YYYY-MM-DD"));
              }}
            />
          </div>
      ...
      <div className="flex justify-center">
        <Button
          ...
          onClick={async () => {
            ...
            if (password.length < 4) return message.error("비밀번호는 5자리 이상이어야 합니다.");
            ...
            console.log("right before signUp!", userForm);
            await signup();
            Router.push("/tour");
          }}
        >
