...
import { Tour, TourSummary } from "./tour.gql";

export const tourLocale = {
  ...baseLocale,
  field: ["Field", "필드"], // 샘플
  totalTour: ["TotalTour", "총 모델"], // 모델명 수정 필요
  name: ["Tour Name", "여행 이름"],
  driver: ["Tour Driver", "주선자"],
...
export type TourLocale = Locale<"tour", Tour & TourSummary, typeof tourLocale>;
